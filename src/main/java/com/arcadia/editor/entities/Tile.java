...
public class Tile extends AQ_Object implements IRotatable {
    /**
     * ////////////////////////////////////////////////////////////////////////////////////////
     * Variables
     * ////////////////////////////////////////////////////////////////////////////////////////
    ...
    private void paintTopDoorOutline(Graphics g){
        ...
        if ((mNeighbors[TOP] != null || mMapPanel.getNeighborMapAtPos(TOP) != null) && getTopDoor() == null) {
    ...
    private void paintRightDoorOutline(Graphics g){
        ...
        if ((mNeighbors[RIGHT] != null || mMapPanel.getNeighborMapAtPos(RIGHT) != null ) && getRightDoor() == null) {
    ...
    private void paintLeftDoorOutline(Graphics g){
        int xStart, yStart, width, height;
        if ((mNeighbors[LEFT] != null || mMapPanel.getNeighborMapAtPos(LEFT) != null ) && getLeftDoor() == null) {
            xStart = mStartX - (mSize / 10);
            yStart = mStartY + 15;
            width = 20;
    ...
    private void paintBottomDoorOutline(Graphics g){
        int xStart, yStart, width, height;
        if ((mNeighbors[BOTTOM] != null || mMapPanel.getNeighborMapAtPos(BOTTOM) != null) && getBottomDoor() == null) {
            xStart = mStartX + (mSize / 10);
    ...
    public Tile getNeighborAtPos(int pos) {
    ...
    public void copy(Tile pTile) {
        ...
        for (int i = 0; i < newImages.length; i++) {
            newImages[i] = deepCopy(pTile.getImageAtPos(i));
        }
